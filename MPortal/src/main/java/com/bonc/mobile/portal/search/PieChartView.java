...
import com.bonc.mobile.common.chart.ChartConfig;
...
public class PieChartView extends LinearLayout {
	static final int[] colorsLib = new int[] { 0xff72b84c, 0xff3cb2ea,
			0xffffb400, 0xffbf0707, 0xffa112d0 };
	...
	protected View getView() {
		buildDataset();
		buildRenderer();
		return ChartFactory.getModulePieChartView(getContext(), dataset,
				renderer);
	}
