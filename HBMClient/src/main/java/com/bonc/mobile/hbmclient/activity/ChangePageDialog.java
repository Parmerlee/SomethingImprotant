...
import com.bonc.mobile.common.view.wheel.widget.adapters.AbstractWheelTextAdapter;
import com.bonc.mobile.common.view.wheel.widget.views.OnWheelChangedListener;
import com.bonc.mobile.common.view.wheel.widget.views.OnWheelScrollListener;
import com.bonc.mobile.common.view.wheel.widget.views.WheelView;
 ...
 *
 */
public class ChangePageDialog extends Dialog implements
	...
	public ChangePageDialog(Context context, List<String> list) {
		super(context, R.style.ShareDialog);
		this.context = context;
		arrProvinces.clear();
		arrProvinces = (ArrayList<String>) list;
	}

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.dialog_broad_page);
