 ...
 *
 */
public class LevelKpiAsynTask extends AsyncTask<Void, Integer, Boolean> {
	private LevelKpiTemplateObservable subject;

	public LevelKpiAsynTask(LevelKpiTemplateObservable o) {
		this.subject = o;
	}
