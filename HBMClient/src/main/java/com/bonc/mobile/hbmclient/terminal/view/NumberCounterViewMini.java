...
/** 小一号 */
public class NumberCounterViewMini extends LinearLayout {
	...
	public NumberCounterViewMini(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public NumberCounterViewMini(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init();
	}
