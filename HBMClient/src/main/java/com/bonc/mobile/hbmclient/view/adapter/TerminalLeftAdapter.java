...
public class TerminalLeftAdapter extends BaseAdapter {
	...
	public TerminalLeftAdapter(Context context,
	...
	public TerminalLeftAdapter(Context context, String[] mLeftTag) {
