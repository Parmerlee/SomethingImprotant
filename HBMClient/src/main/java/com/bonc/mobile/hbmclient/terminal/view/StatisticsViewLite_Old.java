...
public class StatisticsViewLite_Old extends LinearLayout {
	...
	public StatisticsViewLite_Old(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init();
	}

	public StatisticsViewLite_Old(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init();
	}
			...
			try {
				if (v instanceof NumberCounterView) {
					...
					if (strings[i] == null || strings[i].equals("-")) {
						...
						num = NumberUtil
								.changeToDouble("".equals(strings[i]) ? "0"
										: strings[i]);
						num *= 100;
