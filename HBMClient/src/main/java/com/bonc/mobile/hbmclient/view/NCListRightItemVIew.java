...
public class NCListRightItemVIew extends LinearLayout {
	private TextView mContentView;
	private TextView mUnitTextView;
	private Context context;

	public NCListRightItemVIew(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		this.context = context;
		inflate(getContext(), R.layout.nc_list_right_item, this);
	...
	public NCListRightItemVIew(Context context, int itemLayoutId) {
		super(context);
		// TODO Auto-generated constructor stub
		this.context = context;
	...
	public void setContentCompoundDrawable(int drawable) {
		mContentView.setCompoundDrawablesWithIntrinsicBounds(drawable, 0, 0, 0);
	}
