 ...
 *
 */
public class StateLevelKpiMonthSwitch extends StateLevelKpiMonth {
	private DateRangeSwitchView2 mSwitchView;

	public StateLevelKpiMonthSwitch(MachineLevelKpi machine,
	...
	public void enter() {
		if (this.mObserver.getContentView() != null) {
			...
			this.mSwitchView = new DateRangeSwitchView2(
					this.mObserver.getActivity(), DateRangeSwitchView2.month);
	...
	public void changeState() {
		...
		this.mMachine.setState(this.mMachine.getStateDaySwitch());
	}
}
