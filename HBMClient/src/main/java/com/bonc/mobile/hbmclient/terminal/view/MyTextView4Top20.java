...
//自定义文本标签，自动换行
public class MyTextView4Top20 extends View {
	private String txt = "";
	private Paint mPaint = new Paint();

	public MyTextView4Top20(Context context) {
		this(context, null);
	}

	public MyTextView4Top20(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public MyTextView4Top20(Context context, AttributeSet attrs) {
	...
	private void init() {
		...
		mPaint.setColor(0xff0061b1);
//		mPaint.setStyle(Style.STROKE);
		mPaint.setTextSize(getRawSize(TypedValue.COMPLEX_UNIT_DIP, 14));
	}
