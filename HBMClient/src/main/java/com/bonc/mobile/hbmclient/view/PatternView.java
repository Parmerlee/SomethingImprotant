...
public class PatternView extends View {
	...
	public PatternView(Context context, AttributeSet attrs) {
		...
		mBitmapCircleDefault = getBitmapFor(R.mipmap.img_btn_code_lock_point_area_default);
		mBitmapCircleGreen = getBitmapFor(R.mipmap.img_btn_indicator_code_lock_point_area_green);
		mBitmapCircleRed = getBitmapFor(R.mipmap.img_btn_indicator_code_lock_point_area_red);
