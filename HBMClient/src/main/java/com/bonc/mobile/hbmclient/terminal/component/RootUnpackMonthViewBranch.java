 ...
 *
 */
public class RootUnpackMonthViewBranch extends ViewBranch {

	private ModuleBasicViewTop10ViewBranch mTop10;
	private ModuleBasicViewBottomBranch mUnpackCount;
	 ...
	 * @param tae
	 */
	public RootUnpackMonthViewBranch(Context c, TerminalActivityEnum tae) {
		super(c, tae);
