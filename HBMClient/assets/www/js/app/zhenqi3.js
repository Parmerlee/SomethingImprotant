	...
	function listadd( dataobj ){
		...
		if( tdata.length < 13 ){
			...
			html += '<li style="padding: 0px 0px 0px 0px;">\
                ...
                <div class="col-ztitle-left" style="width:30%">集团到达数</div>\
                <div class="col-ztitle-middle" style="width:30%">集团客户统付</div>\
                <div class="col-ztitle-right" style="width:30%">集团成员到达数</div>\
                </div></li>'
      ...
      html2 += '<li style="padding: 0px 0px 0px 0px;">\
                <div class="grid ztitle-grid">\
                  <div class="col-ztitle-left" style="width:10%"></div>\
                <div class="col-ztitle-left" style="width:30%" >集团成员收入</div>\
                <div class="col-ztitle-middle" style="width:30%" >3G/4G渗透率</div>\
                <div class="col-ztitle-right" style="width:30%" >流量统付</div>\
                </div></li>'
      $('#zhenqi3page2').append(html2);

      var html3='';
      html3 += '<li style="padding: 0px 0px 0px 0px;">\
                <div class="grid ztitle-grid">\
                  <div class="col-ztitle-left" style="width:10%"></div>\
                <div class="col-ztitle-left" style="width:30%">专线收入</div>\
                <div class="col-ztitle-middle" style="width:30%">IMS</div>\
                <div class="col-ztitle-right" style="width:30%">行业应用卡</div>\
                </div></li>'
      $('#zhenqi3page3').append(html3);

			var html4='';
			html4 += '<li style="padding: 0px 0px 0px 0px;">\
                <div class="grid ztitle-grid">\
                  <div class="col-ztitle-left" style="width:10%">\
                    <p class="icon arrow-left-zl" style="color:#fff;height:15px;top:0px"></p></div>\
                 <div class="col-ztitle-middle" style="width:45%" >省内物联卡</div>\
                 <div class="col-ztitle-right" style="width:45%" >兴业云</div>\
                </div></li>'
		...
		for (var i = 0; i < dataobj.length; ++i) {
			...
			var tareaName ='';
      if( dataobj[i].AREA_NAME != undefined && dataobj[i].AREA_NAME != null && dataobj[i].AREA_NAME != 'null' ){
        tareaName += dataobj[i].AREA_NAME;
      }else{
        tareaName += '--';
      }
...
function ordersadd( dataorders,tareaName,flag ){
	for(var j=0,html='',html2='',html3='',html4=''; j < dataorders.length;++j ){
       ...
       html4 +='<li><div class="areatag" >'+ tareaName +'</div>\
			       ...
			       html +='<li style="padding: 0px 0px 0px 0px;">\
                    <div class="grid three-grid"><div class="col-1" style="width:10%"><div class="areatag" >'+ tareaName +'</div></div>';
             html2 +='<li style="padding: 0px 0px 0px 0px;">\
                    <div class="grid three-grid"><div class="col-1" style="width:10%"><div class="areatag" >'+ tareaName +'</div></div>';
             html3 +='<li style="padding: 0px 0px 0px 0px;">\
                    <div class="grid three-grid"><div class="col-1" style="width:10%"><div class="areatag" >'+ tareaName +'</div></div>'; 
        ...
        html2 +='<div class="col-1" style="width:30%">\
                        <div class="grid">\
                            <div class="col-1 left" ></div>\
                                  <div class="col-1 right" >\
                                      <i class="icon '+sicon+' right"  style="color: '+ scolor +'" ></i>\
        ...
        html3 +='<div class="col-1" style="width:30%">\
                        <div class="grid">\
                            <div class="col-1 left" ></div>\
                                  <div class="col-1 right" >\
                                      <i class="icon '+sicon+' right"  style="color: '+ scolor +'" ></i>\
				        ...
				        html4 +='<div class="col-1" style="width:45%">\
                        <div class="grid">\
                            <div class="col-1 left" ></div>\
                                  <div class="col-1 right" >\
                                      <i class="icon '+sicon+' right"  style="color: '+ scolor +'" ></i>\
