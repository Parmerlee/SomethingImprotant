...
public class MD5 {
	...
	private final static String signature = "98:FD:43:99:D1:82:51:6C:C8:3D:F0:05:71:85:90:8C";
	...
	public static boolean checkSign(Context context) {
		...
		try {
			...
			flag = md5.equals(str.replace(":", "").toLowerCase());
	...
	private static String getSign(Context context)
		...
		if ((signs == null) || (signs.length == 0)) {
			...
			localMessageDigest.update(sign.toByteArray());
